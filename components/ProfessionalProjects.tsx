...
const secondary: Project[] = [
  ...
  {
    client: "Rockstar Games / 4mm",
    via: "via TeraCode",
    period: "2010 — 2012",
    headline: {
      en: "Social network for a video game studio",
      es: "Red social para un estudio de videojuegos",
    },
    description: {
      en: "Led PHP development of a Joomla-based social community for 4mm Games (Rockstar Games partner) — video uploads, user video battles, community voting system.",
      es: "Lideré el desarrollo PHP de una comunidad social basada en Joomla para 4mm Games (partner de Rockstar Games) — subida de videos, batallas de videos, sistema de votación.",
    },
    tags: ["PHP 5", "Symfony", "Doctrine", "MySQL", "JavaScript"],
  },
  {
    client: "Defjam Rapstar",
    via: "via TeraCode · NYC",
    period: "2010 — 2011",
    headline: {
      en: "Rap karaoke game web portal",
      es: "Portal web del juego de karaoke de rap",
    },
    description: {
      en: "PHP portal for the Defjam Rapstar console game — rap karaoke, video upload & sharing, user video battles with community voting. 3-month on-site collaboration in New York City.",
      es: "Portal PHP para Defjam Rapstar — karaoke de rap, subida y compartición de videos, batallas con votación comunitaria. Colaboración de 3 meses on-site en Nueva York.",
    },
    badge: "On-site NYC",
    tags: ["PHP", "MySQL", "jQuery", "Gerrit"],
  },
  {
    client: "Twitter TTS — Accessibility",
    via: "via TeraCode",
    period: "2011 — 2012",
    headline: {
      en: "Twitter feed reader for blind users & drivers",
      es: "Lector de Twitter para usuarios ciegos y conductores",
    },
    description: {
      en: "Android app reading Twitter feeds aloud via Text-to-Speech — built for blind users, widely adopted by drivers and anyone needing hands-free tweet consumption.",
      es: "App Android que lee el feed de Twitter en voz alta mediante Text-to-Speech — construida para usuarios ciegos, adoptada por conductores y usuarios que necesitan manos libres.",
    },
  ...
  },
  {
    ...
    period: "2009 — 2010",
    headline: {
      en: "iTunes-like DRM-free music app for Android",
      es: "App de música DRM-free similar a iTunes",
    },
    description: {
      en: "Android app + PHP backend for a DRM-free music store — search, browse, preview, and purchase individual songs or full albums. Early Android commerce.",
      es: "App Android + backend PHP para una tienda de música sin DRM — búsqueda, navegación, preescucha y compra de canciones individuales o álbumes completos.",
    },
