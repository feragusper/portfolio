...
const eras: Era[] = [
  ...
  },
  {
    ...
    companies: [
      ...
      },
      {
        ...
        description: {
          en: "2.5 years on one of Europe's largest restaurant reservation platforms. A/B testing at scale, GraphQL APIs, Jetpack Compose migration, Firebase analytics. Started integrating GitHub Copilot and LLMs into the daily workflow — accelerating feature delivery, structuring PR descriptions, and organizing backlog grooming.",
          es: "2 años y medio en una de las plataformas de reservas de restaurantes más grandes de Europa. A/B testing a escala, APIs GraphQL, migración a Jetpack Compose. Comencé a integrar GitHub Copilot y LLMs en el flujo diario — acelerando la entrega de features, estructurando PRs y organizando el backlog.",
        },
      ...
      },
      {
        ...
        location: "Spain · Remote",
        description: {
          en: "Smart building & IoT platform — intercom integrations, access control systems, residential and commercial building management. Fully adopted GitHub Copilot and LLMs as core development tools: AI-assisted code generation, ticket grooming, technical documentation, and PR review workflows.",
          es: "Plataforma de acceso inteligente y IoT — integración con intercomunicadores, sistemas de control de acceso, gestión de edificios. Adopté GitHub Copilot y LLMs como herramientas core: generación de código asistida por IA, grooming de tickets, documentación técnica y revisión de PRs.",
        },
  ...
  },
  {
    ...
    description: {
      en: "Joined REWE digital from Málaga with a hybrid setup. Besides feature delivery, part of the architecture group shaping how the entire mobile organization adopts AI and agentic developer workflows.",
      es: "Me uní a REWE digital desde Málaga en formato híbrido. Además de la entrega de features, formo parte del grupo de arquitectura que define cómo toda la organización mobile adopta IA y flujos de trabajo agénticos.",
    },
    accent: "#f4a261",
    ...
    companies: [
      {
        ...
        location: "Málaga, Spain · Hybrid",
        description: {
          en: "Building Android solutions for one of Germany's largest grocery retail ecosystems — Clean Architecture (MVI), Jetpack Compose, REWE Design System (RDS). Part of the architecture group evaluating and rolling out AI developer tools across all mobile teams: defining standards, building a custom MCP server, and enabling agentic workflows. Personal stack includes Claude, GitHub Copilot, Codex, Lovable, and Devin.",
          es: "Construyendo soluciones Android para uno de los mayores ecosistemas minoristas de Alemania — MVI, Jetpack Compose, RDS. Parte del grupo de arquitectura que evalúa y despliega herramientas de IA para todos los equipos mobile: definiendo estándares, construyendo un servidor MCP propio y habilitando flujos agénticos. Stack personal: Claude, GitHub Copilot, Codex, Lovable, Devin.",
        },
